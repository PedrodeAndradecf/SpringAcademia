...
import Backend.Estudo.SpringAcademia.projection.AlunosPorCidadeProjection;
import Backend.Estudo.SpringAcademia.projection.FaturamentoMensalProjection;
import Backend.Estudo.SpringAcademia.projection.FaturasEmAbertoProjection;
import org.springframework.data.jpa.repository.Query;

import java.util.List;

public interface RelatorioAcademiaRepository {
